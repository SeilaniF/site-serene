...
import { FaCheck, FaHandHoldingHeart, FaBalanceScale, FaBaby } from "react-icons/fa";
import "./About.css";
...
export default function About() {
      ...
      <div className="about-container">
        ...
        <div className="about-header">
          ...
          <p className="subtitle">
            Especialistas em auxiliar mães e gestantes a receberem o benefício que merecem!
          </p>
        </div>
        ...
        <div className="about-block">
          ...
          <div className="about-content">
            ...
            <p>
              A <span className="highlight">Serene</span> é uma empresa especializada em auxiliar mães e gestantes na solicitação do salário-maternidade. Contamos com toda a estrutura necessária para proporcionar um atendimento ético e humanizado.
            </p>
            ...
            <a href="https://wa.link/y9jum1" target="_blank" className="cta-btn">
        ...
        <div className="about-block reverse">
          ...
          <div className="about-content">
            ...
            <p>
              O Salário Maternidade é um benefício concedido para mães desempregadas que já trabalharam pelo menos <strong>1 dia com carteira assinada</strong> antes do nascimento do filho.
            </p>
            ...
            <div className="benefit-details">
              <div className="detail-item">
                ...
                <div className="detail-text">
                  Receba todo o valor em uma única parcela se a criança tiver mais de 4 meses de nascida
                </div>
              </div>
              <div className="detail-item">
                <div className="detail-icon">✓</div>
  ...
  <div className="about-content">
    ...
    <p>
      <strong>Gestantes ou mães com filhos menores de 5 anos</strong> que já tiveram vínculo empregatício formal podem ter direito ao benefício.
    </p>
    ...
    <div className="benefit-details">
      <div className="detail-item">
        <div className="detail-icon">✓</div>
        <div className="detail-text">Trabalhou com carteira assinada (CLT)</div>
      </div>
      <div className="detail-item">
        <div className="detail-icon">✓</div>
        <div className="detail-text">Foi autônoma com contribuição ao INSS</div>
      </div>
      <div className="detail-item">
        <div className="detail-icon">✓</div>
        <div className="detail-text">Foi Microempreendedora Individual (MEI)</div>
      </div>
      <div className="detail-item">
        <div className="detail-icon">✓</div>
        <div className="detail-text">Trabalhou como empregada doméstica</div>
      </div>
      <div className="detail-item">
        <div className="detail-icon">✓</div>
        <div className="detail-text">
          Natimorto <small>(óbito do bebê durante a gestação ou parto)</small>
        </div>
      </div>
    </div>
